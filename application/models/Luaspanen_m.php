...
class Luaspanen_m extends CI_Model {

    public function get($id = null)
    {
        $this->db->select('*');
        $this->db->from('ds_luaspanen');
        if($id != null) {
    ...
    public function add($post)
    {
        ...
        $this->db->insert('ds_luaspanen', $params);
    }
    ...
    public function edit($post)
    {
        ...
        $this->db->update('ds_luaspanen', $params);
    }

    public function delete($id)
	{
        $this->db->where('id_komoditas', $id);
        $this->db->delete('ds_luaspanen');
    }
    ...
    public function getChartData($awal = null, $akhir = null) {
        ...
        $response = $this->db->get("ds_luaspanen");
        return $response;
    }
}