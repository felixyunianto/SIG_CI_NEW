...
<!-- Main content -->
  ...
  <div class="box">
        <div class="box-header">
            <h3 class="box-title">Data Provitas</h3>
            <div class="pull-right">
                <a href="<?=site_url('provitas/add')?>" class="btn btn-primary btn-flat">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center" width="160px">
                            <form action="<?=site_url('provitas/delete')?>" method="post">
                                <a href="<?=site_url('provitas/edit/'.$data->id_komoditas)?>" class="btn btn-warning btn-xs">
